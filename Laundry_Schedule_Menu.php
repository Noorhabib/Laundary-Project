...
{
	document.getElementById("message").innerHTML= "Please Slelect Date, Day and Timeslot.(Incomplete Data!!!!)";
	return false;
}else if (document.getElementById("Day").value == "")
{
	document.getElementById("message").innerHTML= "Please Slelect Day and Timeslot.(Incomplete Data!!!!)";
	return false;
}else if (document.getElementById("STime").value == "")
{
	document.getElementById("message").innerHTML= "Please Slelect Timeslot.(Incomplete Data!!!!)";
	return false;
...
?>
!!!!</h1>
<h2>Please Slelect Below the Laundry Schedule.</h2> 
<div class= "container"> 
<?php 
